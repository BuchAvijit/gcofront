      ...
      <Grid container alignItems="center" className={classes.header}>
        <Grid item className={classes.heroText}>
          <Typography variant="h4" gutterBottom>
            Learn JAVA , React , Web Apps & More
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
            Learn How To Build Websites & Apps by your own
          </Typography>
      ...
      <Box my={5} style={{ minHeight: 520 }}>
        <Box mx={6} py={3}>
          <Typography variant="h5" gutterBottom>
            <strong>The best selection of courses </strong>
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} minWidth={315} alignSelf="center">
            ...
            <Box mt={3}>
              <Typography>
                Simply sign up as a verified user on Get Certified Online to start to
        ...
        >
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                Get Certified Online is collect on many resourses. People who study at
                  the Get Certified Online can archive knowledge by join suitable topic.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                <Typography variant="h4">
                Get Certified Online users easy to achieve the desired skills
                </Typography>
                <Typography style={{ marginTop: 16 }}>
                  Get Certified Online is meticulously built to enhance the
